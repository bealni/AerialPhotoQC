...
{
    public partial class InputCtrl : UserControl
    {
        ...
        /*=== InputCtrl_Resize() ===*/
        private void InputCtrl_Resize(object sender, EventArgs e)
        {
