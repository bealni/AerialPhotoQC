...
namespace AerialPhotoQC
{
    public class LasReader_12
    {
        ...
        private const int HEADER_SIZE = 227;
        ...
        private UInt64[] m_nHDR_PntByRetCount;                  // [15], as according to version 1.4
        ...
        /*=== Constructor ===*/
        public LasReader_12(String FileName)
        {
        ...
        private int ReadHeader()
        {
            ...
            try
            {
                ...
                PntDataRecCount = (UInt64)(m_BR.ReadUInt32());

                for (i = 0; i < 5; i++)
                    PntByRetCount[i] = (UInt64)(m_BR.ReadUInt32());
                for (i = 5; i < 15; i++)
                    PntByRetCount[i] = 0;
